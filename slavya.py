...
async def handle_count(message: types.Message):
    ...
    day = m.split()[0]
    if day == 'Mon':
        await message.reply('Данное расписание для *⚠️ПЕРВОГО⚠️ института.*\n\n\nРасписание на понедельник:\n\n9:00-10:30 - физика\n14:45-18:00 - история\n\n\n*🛑Время МОСКОВСКОЕ🛑*\n\n\nИсправление ошибок/добавить расписание вашего института - писать @LeERoYTheSaint', parse_mode='markdown')
    elif day == 'Tue':
        await message.reply('Данное расписание для *⚠️ПЕРВОГО⚠️ института.*\n\n\nРасписание на вторник:\n\n9:30-11:00 - физика\n9:00-10:30 - аяп\n16:30-18:00 - аяп\n\n\n*🛑Время МОСКОВСКОЕ🛑*\n\n\nИсправление ошибок/добавить расписание вашего института - писать @LeERoYTheSaint', parse_mode='markdown')
    elif day == 'Wed':
        await message.reply('Данное расписание для *⚠️ПЕРВОГО⚠️ института.*\n\n\n💠Среда - выходной🎉\n\n\nИсправление ошибок/добавить расписание вашего института - писать @LeERoYTheSaint')
    elif day == 'Thu':
